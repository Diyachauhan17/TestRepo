...
function Task3() {
  ...
  return (
    <div className='place-items-center m-2.5 p-2 bg-gray-600 text-white'>
        <div className='text-3xl font-bold py-3'>Products</div>

        {/* TV section */}
        <div class="place-items-center bg-blue-100 m-3 rounded-2xl p-2 text-black">
          ...
          {/* AC section */}
          <div class="place-items-center bg-blue-100 rounded-2xl p-2 text-black m-3">
